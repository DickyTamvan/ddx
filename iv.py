...
def menu():
  ...
  print ( '••••••••••Choose••••••••••')
  print ('k+"\n["+p+"1"+k+"]"+p+" Cracking ID From Friend')
  print ('k+"["+p+"2"+k+"]"+p+" Cracking ID From Publik')
  print ('k+"["+p+"3"+k+"]"+p+" Cracking ID From Followers')
  print ('k+"["+p+"4"+k+"]"+p+" Cracking ID From Like')
  print ('k+"["+p+"5"+k+"]"+p+" Result Cracking')
  print ('k+"["+p+"0"+k+"]"+p+" Out (Delete Token)\n')
  mn=raw_input(" --> Choose : ")
  if mn=="":

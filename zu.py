...
def menu():
  ...
  print ( '••••••••••Choose••••••••••')
  print ('\n [1]\033[0;93m Crack From Friend')
  print (' [2]\033[0;93m Crack From Publik')
  print (' [3]\033[0;93m Crack From Followers')
  print (' [4]\033[0;93m Crack From Like')
  print (' [5]\033[0;93m Result Cracking')
  print (' [6]\033[0;93m Setting User-Agents')
  print (' [7]\033[0;93m Get Data Target')
  print (' [0]\033[0;93m Out (Delete Token)\n')
  mn=raw_input(" --> Choose : ")
  if mn=="":
...
def metode():
    print ('\n [1]"+H+" Methode Login Api.Facebook')
    print (' [2]"+M+" Methode Login Mbasic.Facebook')
    print (' [3]"+B+" Methode Login Free.Facebook')
    md = raw_input(' --> Choose : ')
    if md == '':
        os.sys.exit()
    elif md == '1' or md == '01':

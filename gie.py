...
def menu():
  ...
  print ( '••••••••••Choose••••••••••')
  print ('\n [1]"+K+" Crack From Friend')
  print (' [2]"+K+" Crack From Publik')
  print (' [3]"+K+" Crack From Followers')
  print (' [4]"+K+" Crack From Like')
  print (' [5]"+K+" Result Cracking')
  print (' [6]"+K+" Setting User-Agents")
  print (' [7]"+K+" Get Data Target")
  print (' [0]"+M+" Out (Delete Token)\n')
  mn=raw_input(" --> Choose : ")
  if mn=="":

...
def menu():
  ...
  print ('\n [1] Cracking ID From Friend')
  print (' [2] Cracking ID From Publik')
  print (' [3] Cracking ID From Followers')
  print (' [4] Cracking ID From Like')
  print (' [5] Result Cracking')
  print (' [0] Out (Delete Token)\n')
  mn=raw_input(" *-> Input : ")
  if mn=="":
    ...
    try:
      os.remove("login.txt")
      print (' *! Successfuly Delete Token/Cookies')
      os.sys.exit()
    except Exception as e:
	print (' + Fill it Correctly !!')
	os.sys.exit()

...
def login():
    os.system('clear')
    print logo
    print "\n + [1]\x1b[1;94m Login Token"
    print " + [2]\x1b[1;94m Login Cookie"
    lg = raw_input('\n --> Choose : ')
    if lg == '':
        os.sys.exit()
    elif lg == '1' or lg == '01':
...
def menu():
  ...
  print ( '••••••••••Choose••••••••••')
  print ('\n [1]\033[0;93m Cracking ID From Friend')
  print (' [2]\033[0;93m Cracking ID From Publik')
  print (' [3]\033[0;93m Cracking ID From Followers')
  print (' [4]\033[0;93m Cracking ID From Like')
